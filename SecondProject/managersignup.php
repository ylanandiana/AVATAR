...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        ...
        if ($checkResult->num_rows > 0) {
            ...
            $insertQuery = "INSERT INTO MANAGER (fullname, username, email, contact, address, password) VALUES (?, ?, ?, ?, ?, ?)";
            ...
            header("Location: manager_registered_success.php");
            exit();
        }
    }
}
...
<head>
    ...
    <title> Manager Sign up | CakeBytes Cafe'</title>
  ...
  <br>
    ...
    <footer class="footer mt-auto py-3 bg-dark text-white">
        <div class="container text-center">
            <span class="text-muted">© <?php echo date("Y"); ?> Dream Cafe'</span>
        </div>
    </footer>
