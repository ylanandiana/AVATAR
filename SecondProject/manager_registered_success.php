...
if(isset($_POST['fullname'], $_POST['username'], $_POST['email'], $_POST['contact'], $_POST['address'], $_POST['password'])) {
...
<meta charset="UTF-8">
    ...
    <title> Manager Registered | CakeBytes Cafe'</title>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="text-center">
                    <!-- Check if $fullname variable has value before displaying it -->
